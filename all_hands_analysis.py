...
def analyze_hand(handstr, payouts=None, return_bestdisc_cnts=True):
    ...
    results = hand.analyze(
        return_full_analysis=False, return_bestdisc_cnts=return_bestdisc_cnts
    )
...
def save_chunks(
    hands_lst, filename_base, payouts=None, chunksize=100000, return_bestdisc_cnts=False
):
    """
...
if __name__ == "__main__":
    ...
    indout = save_chunks(
        all_hands_str_l,
        "poker_hands_win_cnts_triplebonusplus_",
        payouts=tripbonusplus_d,
        chunksize=200000,
